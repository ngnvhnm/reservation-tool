...
=== Anwendung testen
Um zu überprüfen, ob die Anwendung korrekt funktioniert, öffne deinen bevorzugten Browser und navigiere zu `localhost:5173` und DevTools öffnen, um eventuelle Fehlermeldungen zu überprüfen.
